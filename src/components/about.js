...
const About = () => (
    <div className="main justify-center">
        <div className="container">
            ...
            <h1 className="font['Poppins'] text-custom-slate-200 mt-2 text-5xl font-medium">Harsh Patel.</h1>
            ...
            <p className="font['Poppins'] text-custom-slate-900 mt-6 text-xl font-normal">I am a full-stack developer with an inclination for machine <br/>learning. Currently, I am pursuing my Masters of Applied <br/>Computer Science at Dalhousie University, Canada.</p>
